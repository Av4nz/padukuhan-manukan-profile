  ...
  return (
    <div className="shadow rounded-2xl w-full h-[16rem] sm:h-[18rem] md:h-[18rem] relative overflow-hidden flex group cursor-pointer" onClick={() => handleClick(path)}>
      <Image
        ...
        width={500}
        height={500}
        className="bg-white w-full h-full bg-center bg-cover object-contain object-center transform transition-transform group-hover:scale-110 duration-300 z-0"
        onError={(e) => {
          e.target.src =
      ...
      <div className="absolute bottom-0 left-0 w-full h-[40%] flex flex-col justify-end p-6 z-[2]">
        <div className="flex items-center">
          <h4 className="text-primary-50 font-semibold text-2xl hover:underline">
            {nama || "Informasi"}
          </h4>
