...
const image = "/images/static/profil/Struktur-Pemerintahan.png";
    ...
    >
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="mt-8 flex items-center justify-center">
          <div className="shadow-lg rounded-2xl w-full aspect-[2.3/1] relative overflow-hidden flex">
            <Image
              src={image || null}
              alt="Gambaran Umum Wilayah"
              fill
              className="bg-white w-full h-full bg-center bg-cover object-contain object-center"
              onError={(e) => {
                e.target.src =
